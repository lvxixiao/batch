...
public class User {
  ...
  public User(String name, boolean gender, boolean isMarried, float age, float height, float weight,
                  String hobby, String address, String disHistory, String habit, String target) {
